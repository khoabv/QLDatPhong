<template>
  <div class="main-content">
    <div class="page-header">
      <h3 class="page-title">Chuyển nhượng đặt phòng</h3>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
        <li class="breadcrumb-item"><a href="#">Quản lý đặt phòng</a></li>
        <li class="breadcrumb-item"><a href="#">Chuyển nhượng</a></li>
      </ol>
      ...
      <form @submit.prevent="validateBeforeSubmit" class="form">
        ...
        <div class="row">
          <div class="form-row col-md-12 margin">
            ...
            <div class="form-group col-md-2" disabled="">
              <label>Người được chuyển nhượng</label>
            </div>
            <div class="form-group col-md-3">
  ...
  export default {
    ...
    methods: {
      ...
      async validateBeforeSubmit() {
        ...
        let response = await axios.post('/api/admin/lichtrinh/chuyennhuong', this.dataUpdate)
