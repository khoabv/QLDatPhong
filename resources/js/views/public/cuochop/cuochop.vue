<template>
  <div class="main-content">
    <div class="page-header">
      <h3 class="page-title">Danh sách cuộc họp của bạn</h3>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
        <li class="breadcrumb-item active">Cuộc họp của bạn</li>
          ...
          <td class="align-center">
            ...
            <div class="btn-group" role="group">
              <v-dropdown :show-arrow="false" theme-light>
                ...
                <v-dropdown-item>
                  <a :href="'/cuochop/detail/' + item.id" class="dropdown-item">
                    <img class="icon_action_in_list" src="/assets/img/detail.png" title="Chi tiết">
                    Chi tiết cuộc họp</a>
                </v-dropdown-item>

                <v-dropdown-item>
                  <a :href="'/cuochop/edit/' + item.id" class="dropdown-item">
                    <img class="icon_action_in_list" src="/assets/img/edit.png" title="Chỉnh sửa">
                    Chỉnh sửa cuộc họp</a>
                </v-dropdown-item>
                <!--<v-dropdown-item>
                  <a :href="'/cuochop/cancel/' + item.id" class="dropdown-item">
                    <img class="icon_action_in_list" src="/assets/img/cancel.png" title="Hủy cuộc họp">
                    Hủy cuộc họp</a>
                </v-dropdown-item>-->
               <!-- <v-dropdown-item v-if="item.trangthai!==2">
                ...
                <v-dropdown-item >
                  <a class="dropdown-item" data-delete
                     data-confirmation="notie" @click="xoaCuocHop(item.id)">
                    <img class="icon_action_in_list" src="/assets/img/delete.png" title="">
                    Xóa
                  </a>
                </v-dropdown-item>
