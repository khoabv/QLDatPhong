        ...
        <div class="card">
          ...
          <div class="card-body">
            <form>
              ...
              <div v-if="dataDetail.link!='' && dataDetail.link!=null" class="form-group row"><label class="col-sm-2 form-control-label bold">Link</label>
                <div class="col-sm-10"><a class="form-control-plaintext" style="color:blue" :href="dataDetail.link">Xem và xử lý yêu cầu tại đây</a></div>
              </div>
