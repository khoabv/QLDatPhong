  ...
  <div class="main-content">
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Thông báo của tôi</a></li>
            ...
            <table class="table table-striped table-bordered m-b-none text-sm">
              ...
              <tr v-for="(item, index) in page.items">
                ...
                <td class="align-center">
                  <a :href="'/thongbao/detail/' + item.id"><i class="icon-fa icon-fa-star"/>Chi tiết</a>
    ...
    methods: {
      async loadPage (page) {
        try {
          ...
          const response = await axios.get(`/api/admin/thongbao/thongBaoCuaToi`,{
            params: {
              page: page,
      ...
      xoaThongBao (id) {
       ...
       async xoaDuLieuThongBao (id) {
        try {
          ...
          window.location.href = '/thongbao/all'
        } catch (error) {
          if (error) {
            window.toastr['error']('Có lỗi xảy ra', 'Error')
          }
